...
def convert_rbn_to_lemon(namespace,
                         lemon,
                         major_version,
                         minor_version,
                         rbn_pos_to_lexinfo,
                         ...
                         output_path=None,
                         verbose=0):
    from .ODWN_reader import senseid_to_sense_obj
    ...
    lexicon_label = f'Referentie Bestand Nederlands versie {major_version}.{minor_version}'
    ...
    pos_tagset = set()
    for sense_id, sense_obj in senseid_to_sense_obj.items():
